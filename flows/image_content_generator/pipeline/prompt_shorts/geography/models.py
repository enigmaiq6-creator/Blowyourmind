...
class GeographyScene(Scene):
    ...
    map_style: str = Field(default="satellite", description="Map style choice for this scene. Choose 'satellite' for realistic imagery, 'dark' for dark vector map, or 'watercolor' for a beautiful Stamen watercolor style.")
