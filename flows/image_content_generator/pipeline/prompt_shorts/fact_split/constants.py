...
FOCUS_AREAS_FACT_SPLIT = [
    "Nature: Gray Wolf Jaw Pressure vs Golden Retriever",
    "Nature: Peregrine Falcon Dive Speed vs Cheetah Land Sprint",
    "Nature: Blue Whale Heart Scale vs African Elephant",
    "Nature: Mantis Shrimp Punch Acceleration vs 22 Caliber Bullet",
    "Nature: Electric Eel Shock Voltage vs Standard Household Socket",
    "Nature: Tardigrade Extreme Survival vs Human Biological Limits",
    "Nature: Honey That Never Decays in Egyptian Tombs vs Modern Preservatives",
    "Nature: Inland Taipan Venom Potency vs King Cobra",
    "Space: Neutron Star Teaspoon Density vs Mount Everest Weight",
    "Space: Surface of Venus Greenhouse Heat vs Mercury Thermal Swings",
    "Space: Speed of Voyager 1 in Deep Space vs Commercial Jetliner",
    "Space: Diameter of VY Canis Majoris Star vs Our Solar System",
    "Space: Outer Space Near Absolute Zero vs Core of the Sun Fusion Heat",
    "Science: Diamond Molecular Hardness vs Single-Atom Graphene Strength",
    "Science: Human Brain 20-Watt Efficiency vs Supercomputer Power Grid",
    "Science: Human Eye 576 Megapixel Resolution vs 70mm IMAX Film",
    "Science: Sound Wave Intensity of Krakatoa Eruption vs Modern Jet Engine",
    "Science: Laser Coherence Light vs Standard Solar Radiation",
    "Earth & Geography: Depth of Mariana Trench vs Height of Mount Everest Inverted",
    "Earth & Geography: Sahara Desert Lush Green History 6000 Years Ago vs Present Arid Dunes",
    "Earth & Geography: Amazon River Freshwater Discharge vs All European Rivers Combined",
    "Earth & Geography: Atacama Rainless Decades vs Cherrapunji Monsoon Deluges",
    "Earth & Geography: Kola Superdeep Borehole Depth vs Earth's Molten Mantle",
    "History & Engineering: Construction Gap Between Pyramids of Giza vs Great Wall of China",
    "History & Engineering: SR-71 Blackbird Titanium Skin vs Modern Stealth Drones",
    "History & Engineering: Nuclear Submarine Titanium Hull vs Deep Sea Kraken Habitat",
    "History & Engineering: International Space Station Speed vs High-Speed Maglev Train",
    "History & Engineering: Deepest Gold Mine at Mponeng vs Surface City Skyscrapers",
    "Physics: Matter vs Antimatter Annihilation Energy Output",
    "Physics: Speed of Light Barrier vs Quantum Entanglement Instantaneous Reaction"
]
